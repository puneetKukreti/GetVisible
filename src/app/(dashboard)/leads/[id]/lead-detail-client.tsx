        ...
        <div className="p-4 rounded-md border border-amber-500/30 bg-amber-500/10 text-amber-800 dark:text-amber-300 flex items-start gap-3">
          ...
          <div className="text-xs space-y-1">
            ...
            <p className="leading-relaxed">
              {lead.duplicateNotes ||
                'This business was identified as a potential duplicate of an existing record in your CRM. Human review is recommended before outreach.'}
            </p>
          </div>
        </div>
      )}
      ...
      {isSuppressed && (
        <div className="p-4 rounded-md border border-destructive/30 bg-destructive/10 text-destructive flex items-start gap-3">
          ...
          <div className="text-xs space-y-1">
            ...
            <p className="leading-relaxed">
              This business is in the organization suppression registry. Per anti-spam principles, all automated or manual outbound emails, calls, and WhatsApp messages are blocked at the engine level.
            </p>
          </div>
        </div>
      )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                <div className="p-2.5 rounded border border-border/60 bg-card">
                  ...
                  <div className="text-[11px] text-muted-foreground mt-0.5">
                    Highlight corporate client onboarding portal, secure document drop box, and HTTPS SSL security compliance.
                  </div>
                </div>
                <div className="p-2.5 rounded border border-border/60 bg-card">
                  <div className="text-[11px] font-semibold text-foreground">Target Decision Maker</div>
                  <div className="text-[11px] text-muted-foreground mt-0.5">
                    Managing Partner / Principal handling client engagements in {lead.city}.
                  </div>
                </div>
              </div>
            </CardContent>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  {lead.sourceUrl ? (
                    ...
                    <span className="text-muted-foreground">Public directory record</span>
                  )}
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-3 text-xs">
              {lead.contacts && lead.contacts.length > 0 ? (
                ...
                <div className="p-3 rounded-md border border-border/60 bg-muted/20 text-muted-foreground">
                  No individual contact records attached yet. Public telephone: {lead.publicPhone || 'None'} / Email: {lead.publicEmail || 'None'}.
                </div>
              )}
            </CardContent>
          </Card>
